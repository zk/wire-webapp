...
z.event.EventTypeHandling =
  ...
  STORE: [
    ...
    z.event.Client.CONVERSATION.FINANCIAL_INFORMATION
    z.event.Client.CONVERSATION.SPEECH_INPUT
    z.event.Client.CONVERSATION.SURVEY_ANSWER
    z.event.Client.CONVERSATION.SURVEY_QUESTION
